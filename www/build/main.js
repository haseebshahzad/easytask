...
var SelectPage = /** @class */ (function () {
    ...
    SelectPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-select',template:/*ion-inline-start:"C:\Users\national\Desktop\Numi\numi1\src\pages\select\select.html"*/'<ion-content padding>\n\n	<img src="assets/imgs/logoz.png" alt="logo">\n\n	<div padding>\n	  <button ion-button block class="btn-login" (click)="goLogin(1)">Worker</button>\n	  <button ion-button block class="btn-login" (click)="goLogin(2)">Work  provider</button>\n	  \n	  <button (click)="signup()" ion-button color="dark" outline block> <ion-icon ios="ios-create" md="md-create" class="c-acc"></ion-icon> CREATE NEW ACCOUNT</button>\n	</div>\n</ion-content>'/*ion-inline-end:"C:\Users\national\Desktop\Numi\numi1\src\pages\select\select.html"*/,
        }),
